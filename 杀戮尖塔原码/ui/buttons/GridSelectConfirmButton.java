...
// Source File Name:   GridSelectConfirmButton.java
...
public class GridSelectConfirmButton
{
    ...
    private void renderControllerUi(SpriteBatch sb)
    {
        ...
        {
            sb.setColor(Color.WHITE);
            sb.draw(CInputActionSet.proceed.getKeyImg(), (current_x - 32F - controller_offset_x) + 96F * Settings.scale, (DRAW_Y - 32F) + 57F * Settings.scale, 32F, 32F, 64F, 64F, Settings.scale, Settings.scale, 0.0F, 0, 0, 64, 64, false, false);
        }
    }
