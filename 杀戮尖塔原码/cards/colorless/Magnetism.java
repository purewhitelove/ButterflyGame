...
// Source File Name:   Magnetism.java
...
public class Magnetism extends AbstractCard
{
    ...
    {
        addToBot(new ApplyPowerAction(p, p, new MagnetismPower(p, magicNumber), magicNumber));
    }
