...
// Source File Name:   CompileDriver.java
...
public class CompileDriver extends AbstractCard
{
    ...
    {
        super("Compile Driver", cardStrings.NAME, "blue/attack/compile_driver", 1, cardStrings.DESCRIPTION, com.megacrit.cardcrawl.cards.AbstractCard.CardType.ATTACK, com.megacrit.cardcrawl.cards.AbstractCard.CardColor.BLUE, com.megacrit.cardcrawl.cards.AbstractCard.CardRarity.COMMON, com.megacrit.cardcrawl.cards.AbstractCard.CardTarget.ENEMY);
        baseDamage = 7;
        baseMagicNumber = 1;
    ...
    public void use(AbstractPlayer p, AbstractMonster m)
    {
        ...
        addToBot(new CompileDriverAction(p, magicNumber));
    }
