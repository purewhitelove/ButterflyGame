...
// Source File Name:   CrushJoints.java
...
public class CrushJoints extends AbstractCard
{
    ...
    public CrushJoints()
    {
        super("CrushJoints", cardStrings.NAME, "purple/attack/crush_joints", 1, cardStrings.DESCRIPTION, com.megacrit.cardcrawl.cards.AbstractCard.CardType.ATTACK, com.megacrit.cardcrawl.cards.AbstractCard.CardColor.PURPLE, com.megacrit.cardcrawl.cards.AbstractCard.CardRarity.COMMON, com.megacrit.cardcrawl.cards.AbstractCard.CardTarget.ENEMY);
        baseDamage = 8;
        baseMagicNumber = 1;
    ...
    public void use(AbstractPlayer p, AbstractMonster m)
    {
        ...
        addToBot(new CrushJointsAction(m, magicNumber));
    }
