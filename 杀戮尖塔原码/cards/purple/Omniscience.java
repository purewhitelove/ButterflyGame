...
// Source File Name:   Omniscience.java
...
public class Omniscience extends AbstractCard
{
    ...
    public Omniscience()
    {
        super("Omniscience", cardStrings.NAME, "purple/skill/omniscience", 4, cardStrings.DESCRIPTION, com.megacrit.cardcrawl.cards.AbstractCard.CardType.SKILL, com.megacrit.cardcrawl.cards.AbstractCard.CardColor.PURPLE, com.megacrit.cardcrawl.cards.AbstractCard.CardRarity.RARE, com.megacrit.cardcrawl.cards.AbstractCard.CardTarget.NONE);
        exhaust = true;
        baseMagicNumber = 2;
