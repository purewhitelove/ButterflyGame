...
// Source File Name:   BlurWaveChaoticEffect.java
...
public class BlurWaveChaoticEffect extends AbstractGameEffect
{
    ...
    public void render(SpriteBatch sb)
    {
        ...
        sb.setColor(color);
        sb.draw(img, x, y, (float)img.packedWidth / 2.0F, (float)img.packedHeight / 2.0F, img.packedWidth, img.packedHeight, scale + MathUtils.random(-0.1F, 0.1F), scale + MathUtils.random(-0.1F, 0.1F), rotation + flipper + MathUtils.random(-30F, 30F));
