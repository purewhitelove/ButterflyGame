...
// Source File Name:   RoomShineEffect2.java
...
public class RoomShineEffect2 extends AbstractGameEffect
{
    ...
    public RoomShineEffect2()
    {
        ...
        y = MathUtils.random((float)Settings.HEIGHT * 0.0F, (float)Settings.HEIGHT * 0.9F) - (float)img.packedHeight / 2.0F;
        ...
        scale = 0.01F;
        targetScale = MathUtils.random(1.0F, 1.5F);
