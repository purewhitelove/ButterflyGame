...
// Source File Name:   ChestShineEffect.java
...
public class ChestShineEffect extends AbstractGameEffect
{
    ...
    public ChestShineEffect()
    {
        ...
        x = (AbstractChest.CHEST_LOC_X + MathUtils.random(-200F, 170F) * Settings.scale) - (float)img.packedWidth / 2.0F;
        y = (AbstractChest.CHEST_LOC_Y + MathUtils.random(-250F, 50F) * Settings.scale) - (float)img.packedHeight / 2.0F;
        ...
        scale = 0.01F;
        targetScale = MathUtils.random(0.5F, 1.2F);
