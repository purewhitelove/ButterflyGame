...
// Source File Name:   MegaDialogTextEffect.java
...
public class MegaDialogTextEffect extends AbstractGameEffect
{
    ...
    public MegaDialogTextEffect(float x, float y, float duration, String msg, com.megacrit.cardcrawl.ui.DialogWord.AppearEffect a_effect)
    {
        wordTimer = 0.0F;
        textDone = false;
        words = new ArrayList();
    ...
    static 
    {
        DEFAULT_WIDTH = 320F * Settings.scale;
        LINE_SPACING = Settings.isMobile ? 33F * Settings.scale : 30F * Settings.scale;
