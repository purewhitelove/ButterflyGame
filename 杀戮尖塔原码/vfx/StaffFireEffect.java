...
// Source File Name:   StaffFireEffect.java
...
public class StaffFireEffect extends AbstractGameEffect
{
    ...
    public StaffFireEffect(float x, float y)
    {
        ...
        vY = MathUtils.random(20F, 140F) * Settings.scale;
        duration = 0.7F;
        color = Color.CHARTREUSE.cpy();
        color.a = 0.0F;
        scale = MathUtils.random(1.1F, 1.2F) * Settings.scale;
        renderBehind = true;
    }
    ...
    public void render(SpriteBatch sb)
    {
        ...
        sb.setColor(color);
        sb.draw(img, x - 64F, y - 64F, 64F, 64F, 128F, 128F, scale * MathUtils.random(1.05F, 1.1F), scale, 0.0F, 0, 0, 128, 128, flippedX, false);
