...
// Source File Name:   BlueCards.java
...
public class BlueCards extends AbstractDailyMod
{
    ...
    public BlueCards()
    {
        super("Blue Cards", NAME, DESC, "blue.png", true, com.megacrit.cardcrawl.characters.AbstractPlayer.PlayerClass.DEFECT);
    }
    ...
    static 
    {
        modStrings = CardCrawlGame.languagePack.getRunModString("Blue Cards");
