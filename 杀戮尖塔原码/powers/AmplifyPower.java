...
// Source File Name:   AmplifyPower.java
...
public class AmplifyPower extends AbstractPower
{
    ...
    {
        if(!card.purgeOnUse && card.type == com.megacrit.cardcrawl.cards.AbstractCard.CardType.POWER && amount > 0)
        {
            flash();
            ...
            amount--;
            if(amount == 0)
                addToBot(new RemoveSpecificPowerAction(owner, owner, "Amplify"));
        }
    }
