...
// Source File Name:   AttackBurnPower.java
...
public class AttackBurnPower extends AbstractPower
{
    ...
    public void atEndOfRound()
    {
        ...
        {
            addToBot(new ReducePowerAction(owner, owner, "Attack Burn", 1));
            return;
        }
    }
    ...
    static 
    {
        powerStrings = CardCrawlGame.languagePack.getPowerStrings("Attack Burn");
